<template>
  ...
  <div class="bottomNav">
    <div
      class="bottomNavItem partOne"
      :class="{ active: ActivePageNum === 1 }"
      @click="isActiveItem(1)"
    >
      part 1
    </div>
    <div
      class="bottomNavItem partTwo"
      :class="{ active: ActivePageNum === 2 }"
      @click="isActiveItem(2)"
    >
      part 2
    </div>
    <div
      class="bottomNavItem partThree"
      :class="{ active: ActivePageNum === 3 }"
      @click="isActiveItem(3)"
    >
      part 3
    </div>
    <div
      class="bottomNavItem partFour"
      :class="{ active: ActivePageNum === 4 }"
      @click="isActiveItem(4)"
    >
      part 4
    </div>
  </div>
